...
<!-- 
## Hi there 👋
**Sonalikasingh17/Sonalikasingh17** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- **Secondary** (2015–2016), CBSE — 9.4 CGPA
...
- **Data Analyst Intern — ERNET India, IIT Madras Research Park** (Jul 2024 – Jan 2025)  
  ...
  - Created 10+ Python visualizations and reports to enhance internet service in remote hilly regions.

- **Winter Intern – ML Techniques, E&ICT Academy, IIT Guwahati** (Dec 2024 – Jan 2025)  
  - Built and tuned deep learning models (FFNNs, CNNs) on MNIST/CIFAR-10 using TensorFlow/Keras.
  - Improved accuracy by 15% and evaluated models using ROC, PR curves, AUC, and confusion matrix.
